...
$controller_node_network       = '127.0.0.1'
...
# OpenStack controller. Change the "ip" to the IP address of your OpenStack controller
  ...
  cobbler_node { "control-server": node_type => "control", mac => "00:11:22:33:44:55:66", ip => "127.0.0.1", power_address  => "127.0.0.1" }
...
# Begin compute node
  cobbler_node { "compute-server01": node_type => "compute", mac => "11:22:33:44:55:66:77", ip => "127.0.0.1", power_address  => "127.0.0.1" }
...
node ubuntu inherits build-node { }

# Change control_server to the host name of your control node
#node ubuntu inherits os_base { class { control: crosstalk_ip => '127.0.0.1'} }

# Change compute_server01 to the host name of your first compute node
#node debian inherits os_base { class { compute: internal_ip => '127.0.0.1', crosstalk_ip => '127.0.0.1'} }
